...
var valueSeries1 = mainPanel.series.push(am5xy.CandlestickSeries.new(root, {
  name: "MSFT",
  clustered: false,
  valueXField: "Date",
  valueYField: "High",
  highValueYField: "High",
  lowValueYField: "High",
  openValueYField: "High",
  forceHidden:true,
  maskBullets:true,
  xAxis: dateAxis,
  yAxis: valueAxis,
}));
var valueSeries2 = mainPanel.series.push(am5xy.CandlestickSeries.new(root, {
  name: "MSFT",
  clustered: false,
  valueXField: "Date",
  valueYField: "Low",
...
//stockChart.set("stockSeries1", valueSeries1);
//stockChart.set("stockSeries2", valueSeries2);
...
valueSeries1.bullets.push(function(root) {
  return am5.Bullet.new(root, {
    ...
    locationY: 0,
     sprite: am5.Picture.new(root, {
      ...
      centerY: am5.percent(100),
      src:'https://img.icons8.com/external-those-icons-flat-those-icons/24/000000/external-Arrow-arrows-those-icons-flat-those-icons-23.png'
    })
  });
});

valueSeries2.bullets.push(function(root) {
  return am5.Bullet.new(root, {
    locationX: 0.5,
    locationY: 0,
    sprite: am5.Picture.new(root, {
      ...
      src:'https://img.icons8.com/external-those-icons-flat-those-icons/24/null/external-Arrow-selection-and-cursors-those-icons-flat-those-icons-11.png'
    })
  });
});